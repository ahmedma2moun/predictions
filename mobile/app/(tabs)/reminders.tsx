...
export default function RemindersScreen() {
  ...
  return <View style={{ flex: 1, backgroundColor: colors.background }}><AppHeader title="Match reminders" subtitle="60 minutes before kickoff" /><ScrollView contentContainerStyle={{ padding: 16, gap: 14, paddingBottom: insets.bottom + 100 }} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={refresh} tintColor={colors.primary} />}>
    <Muted>Choose at least two teams in a league. You will only be notified for matches between selected teams.</Muted>
