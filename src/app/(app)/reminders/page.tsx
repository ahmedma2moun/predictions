...
export default function RemindersPage() {
  ...
  return <div className="space-y-5 max-w-3xl mx-auto">
    <div><h1 className="text-2xl font-bold flex items-center gap-2"><Bell className="h-6 w-6" /> Match reminders</h1><p className="text-muted-foreground mt-1">Get a reminder 60 minutes before fixtures between two teams you follow in the same league.</p></div>
